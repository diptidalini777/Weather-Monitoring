...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Weather: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.WeatherFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.WeatherAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface WeatherDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    /**
     * Find zero or more Weathers that matches the filter.
     * @param {WeatherFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const weather = await prisma.weather.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
     */
    findRaw(args?: WeatherFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Weather.
     * @param {WeatherAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const weather = await prisma.weather.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: WeatherAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface WeatherFieldRefs {
    ...
    readonly mainCondition: FieldRef<"Weather", 'String'>
   ...
   * Weather findRaw
   */
  export type WeatherFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Weather aggregateRaw
   */
  export type WeatherAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type WeatherWhereInput = {
    ...
    feelsLike?: FloatFilter<"Weather"> | number
    mainCondition?: StringFilter<"Weather"> | string
  ...
  export type WeatherScalarWhereWithAggregatesInput = {
    ...
    feelsLike?: FloatWithAggregatesFilter<"Weather"> | number
    mainCondition?: StringWithAggregatesFilter<"Weather"> | string
  ...
  export type WeatherUpdateInput = {
    ...
    mainCondition?: StringFieldUpdateOperationsInput | string
